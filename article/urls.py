...
from article import views, generic_views, publication_logic
...
urlpatterns = [
    ...
    path('pending-requests/', publication_logic.pending_publication_requests, name='pending_publication_requests'),
]
