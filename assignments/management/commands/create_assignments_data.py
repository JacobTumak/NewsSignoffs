...
"""
        ...
        for data in assignments_data:
            ...
            assign_project_signoff = assignment.approval.get_next_signoff(for_user=staff_user)
            assign_project_signoff.sign(user=staff_user)
            author_user = data["assigned_to"]
            accept_project_signoff = assignment.approval.get_next_signoff(for_user=author_user)
            accept_project_signoff.sign(user=author_user)
        submit_completed_signoff = assignment.approval.get_next_signoff(for_user=author_user)
        submit_completed_signoff.sign(user=author_user)
        confirm_completion_signoff = assignment.approval.get_next_signoff(for_user=staff_user)
        confirm_completion_signoff.sign(user=staff_user)
