...
urlpatterns = [
    ...
    path("new-assignment/", views.create_assignment_view, name="fake_new_assignment"),
    path(
        "assignment-detail/<int:assignment_id>/",
        views.assignment_detail_view,
        name="assignment_detail",
    ),
    path(
        "all-assignments/", generic_views.all_assignments_view, name="all_assignments"
    ),
